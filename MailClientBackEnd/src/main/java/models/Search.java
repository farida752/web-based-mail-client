...
public class Search {
	...
	/////////////////////////////////////////////////////////////////////////////////
public String[]  searchContact(LinkedList contacts) {
		
		String[] contactsResult = new String[contacts.size()];
		 int j=0;
		...
		/*	String[] email = convertSentance((String)contacts.get(i));
			
        
			if(BinarySearch(email,wordToSearch) != -1 ) {
				contactsResult[j]=(String)contacts.get(i);
				j++;
				continue;
			}*/
			if(((String)contacts.get(i)).contains(wordToSearch) ) {
				contactsResult[j]=(String)contacts.get(i);
				j++;
				continue;
			}
